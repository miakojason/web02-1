INSERT INTO `news` (`id`, `title`, `text`, `type`, `good`, `sh`) VALUES (NULL, '缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%(一)', '資料來源： 行政院衛生署國民健康局 
發佈日期： 2012 / 10 / 07
...
7. 減少看電視、打電玩等靜態生活的時間。
    民眾對運動如有疑問，可參考國民健康局肥胖防治網-「快樂動」(http://obesity.bhp.gov.tw)，亦可撥打免費市話健康體重管理電話諮詢服務，諮詢專線「0800-367-100（0800-瘦落去-要動動）」，也可利用國民健康局局網首頁或肥胖防治網問題諮詢專區的網路電話撥入功能，向客服人員諮詢關於運動、健康飲食及健康體重管理等相關疑問。', '1', '0', '1');
INSERT INTO `news` (`id`, `title`, `text`, `type`, `good`, `sh`) VALUES (NULL, '菸害防治法規(一)', '第二十三條　　違反第五條或第十條第一項規定者，處新臺幣一萬元以上五萬元以下罰鍰，並得按次連續處罰。
...
', '2', '0', '1');
INSERT INTO `news` (`id`, `title`, `text`, `type`, `good`, `sh`) VALUES (NULL, '菸害防治法規(二)', '第二十三條　　違反第五條或第十條第一項規定者，處新臺幣一萬元以上五萬元以下罰鍰，並得按次連續處罰。
第二十四條　　製造或輸入違反第六條第一項、第二項或第七條第一項規定之菸品者，處新臺幣一百萬元以上五百萬元以下罰鍰，並令限期回收；屆期未回收者，按次連續處罰，違規之菸品沒入並銷毀之。
販賣違反第六條第一項、第二項或第七條第一項規定之菸品者，處新臺幣一萬元以上五萬元以下罰鍰。
第二十五條　　違反第八條第一項規定者，處新臺幣十萬元以上五十萬元以下罰鍰，並令限期申報；屆期未申報者，按次連續處罰。
規避、妨礙或拒絕中央主管機關依第八條第二項規定所為之取樣檢查（驗）者，處新臺幣十萬元以上五十萬元以下罰鍰。
...
第三十三條　　本法所定罰則，除第二十五條規定由中央主管機關處罰外，由直轄市、縣（市）主管機關處罰之。
', '2', '0', '1');
INSERT INTO `news` (`id`, `title`, `text`, `type`, `good`, `sh`) VALUES (NULL, '降低罹癌風險 建構健康生活型態(一)', '癌症防治   三管齊下  Part 1 降低罹癌風險建構健康生活型態 
...
上稿日期：2010/1/20
', '3', '0', '1');
INSERT INTO `news` (`id`, `title`, `text`, `type`, `good`, `sh`) VALUES (NULL, '降低罹癌風險 建構健康生活型態(二)', '癌症防治   三管齊下  Part 1 降低罹癌風險建構健康生活型態 
