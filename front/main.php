...
<div class="tags">
    <div id="sec01" class="tag active clo">健康新知</div>
    <div id="sec02" class="tag clo">菸害防治</div>
    <div id="sec03" class="tag clo">癌症防治</div>
    <div id="sec04" class="tag clo">慢性病防治</div>
</div>
<article>
...
<script>
    $(".tag").on('click', function() {
        ...
        let id = $(this).attr('id').replace("sec","section")//id=sec01，然後取代sec變為section=>id=section01
        $("section").hide();
        $("#"+id).show();
    })
</script>